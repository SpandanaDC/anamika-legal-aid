...
import { Menu, User, HelpCircle, LogOut, LayoutDashboard } from 'lucide-react';
      ...
      <nav className="w-full py-4 bg-white/80 backdrop-blur-md shadow-sm fixed top-0 z-50">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <Link to="/" className="flex items-center">
            <div className="h-8 w-8 rounded-full bg-kanoon-dark-violet text-white flex items-center justify-center font-serif font-bold mr-2">
              KV
            </div>
